...
chrome.find_element(By.CSS_SELECTOR, "input[id='first-name']").send_keys("Popescu")
# chrome.find_element(By.XPATH, "//input[@id=\"first-name\"]").send_keys("Popescu") #with escaped "
chrome.find_element(By.XPATH, "//input[@id='first-name']").send_keys("Popescu")
time.sleep(3)
